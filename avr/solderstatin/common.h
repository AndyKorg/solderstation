/*
 * Описание общих структур данных и макросов
 */
...
//Возможные методы регулирования
typedef	enum {
	METHOD_PID,		//PID регулироввание
	METHOD_SIMPLE,	//Простое пропорциональное регулирование
	METHOD_NOT_APP,
} method_reg_t;
...
typedef struct  {
    ...
    int16_t I_Factor;
    int16_t D_Factor;
	method_reg_t Method; //Метод регулирования
} settind_dev_t ;

//список установок устройств, собственно он и сохраняется в EEPROM
typedef struct {
