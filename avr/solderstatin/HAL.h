...
#define SOLDER_KOEF_DISP		100		//Поправочный коэффицент на который умножается значение перед выводом на дисплей, подбирается при настройке
...
#define SOLDER_PWM_OCR_INIT		((1<<COM1A1) | (0<<COM1A0))								//"прямой" pwm - чем больше число в OCR тем шире имульс
...
#define FAN_HEAT_PWM_OCR_INIT	((1<<COM1B1) | (0<<COM1B0))								//"прямой" pwm - чем больше число в OCR тем шире имульс
